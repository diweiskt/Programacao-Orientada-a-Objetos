...
import br.upf.ccc.App02.util.Teclado;
...
public class AppUserConsole {
    ...
    public static void main(String[] args){
        ...
        while (true){
            ...
            lido = Teclado.lerInteger("Informe uma opção: ");
            System.out.println("----------------------------------------------------");
            switch (lido) {
                case 1:
                    criar();
    ...
    private static void excluir() {
        ...
        // 2. Buscar a conta na coleção de contas
/*
...
*/
    ...
    private static void listar() {
        ...
        if (contas.isEmpty()) {
            ...
            for (Conta conta : contas) {
                System.out.println("Número: " + conta.getNumero() + ", Titular: " + conta.getTitular() + ", Saldo: " + conta.getSaldo());
            }
        }
    }
