...
public class TelaContas extends javax.swing.JFrame {
    ...
    public TelaContas() {
        initComponents();
        // gerar algumas contas mock
        contas.add(new Conta(1, "Um"));
        contas.add(new Conta(2, "Dois"));
        contas.add(new Conta(3, "Três"));
        // simular o click no listar para abrir já listando!
